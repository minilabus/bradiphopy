...
def _build_arg_parser():
    ...
    p.add_argument("tgt_file", help="Target filename (must be supported by VTK).")
    p.add_argument("out_file", help="Output filename as TXT.")
    p.add_argument("--annot_lut", help="LUT for consistency between Epoch/Subject")
    p.add_argument(
        "--distance",
        type=float,
        default=0.002,
