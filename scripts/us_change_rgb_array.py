# Utility script to change the RGB values of a VTK polydata file
...
new = BraDiPhoHelper3D.generate_bdp_obj(
    bdp.get_polydata_vertices(), bdp.get_polydata_triangles()
)
