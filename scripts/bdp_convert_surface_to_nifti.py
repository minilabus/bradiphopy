...
(This means the surface vertices should be in LPS coordinates)
"""
...
def _build_arg_parser():
    ...
    p.add_argument("in_surface", help="Input surface file.")
    p.add_argument("in_ref", help="Input reference NIFTI file.")
    p.add_argument("out_file", help="Output NIFTI file.")
    p.add_argument(
        "-f",
        dest="overwrite",
        action="store_true",
