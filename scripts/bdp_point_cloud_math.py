...
from bradiphopy.bdp_ops import apply_intersection, apply_union, apply_difference
...
def _build_arg_parser():
    ...
    p.add_argument(
        ...
        metavar="INPUT_FILES",
        nargs="+",
        help="The list of files that contain the " + "points to operate on.",
    )
    p.add_argument(
        "out_file",
        metavar="OUTPUT_FILE",
        help="The file where the remaining points are saved.",
    )
